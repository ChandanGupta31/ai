...
class _AnimalState extends State<Animal> {
  ...
  String? prey = ' ';
  String? name_of_young = ' ';
  String? group_behavior = ' ';
  String? estimated_population_size =' ';
  String? biggest_threat = ' ';
  String? most_distinctive_feature = ' ';
  String? gestation_period = ' ';
  String? habitat = ' ';
  String? diet = ' ';
  String? average_litter_size = ' ';
  String? lifestyle = ' ';
  String? common_name = ' ';
  String? number_of_species = ' ';
  String? location =' ';
  String? slogan= ' ';
  String? group =' ';
  String? color = ' ';
  ...
  String? weight =' ';
  String? height = ' ';
  String? age_of_sexual_maturity =' ';
  String? age_of_weaning =' ';
